# Qwen Live Harness audit corrections
...
width/height pair. `QWEN_LIVE_HARNESS_CAMERA_SNAPSHOT_RESOLUTION` overrides it.
...
`.qwen/e2e-tests/2026-09-05-qwen-live-harness-audit-fixes.md`. Verification uses source
