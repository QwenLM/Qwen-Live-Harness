# Qwen Live Harness stable orb and settings
...
Renderer changes stay in qwen-live-harness-host, retaining Memory action validation and
...
Primary files: qwen-live-harness-host renderer/main.ts, style.css, memory-panel.ts and new
