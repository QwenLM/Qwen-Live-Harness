# Pebble UI for Qwen Live Harness Host

[English](live-pebble-ui.md) | [简体中文](live-pebble-ui.zh-CN.md)

## Implementation baseline

This change targets `QwenLM/Qwen-Live-Harness` main at `178d1779f4bb95b35f0d589c55ccd889491e6c8e`, using `packages/qwen-live-harness-host` and `packages/qwen-live-harness`. Preserve the existing daemon ownership/bootstrap, audio recovery, discovered sessions, instruction delivery records, session reports, and search task controls while changing their presentation.
...
2. Build and typecheck Host; run the repository build/typecheck requirements
