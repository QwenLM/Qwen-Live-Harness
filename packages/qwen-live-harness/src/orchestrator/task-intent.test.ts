...
describe('explicit current-user task intent', () => {
  ...
  it.each<[TaskIntentKind, string]>([
    ['monitor', '你要是看见我打开知乎，就让我别玩，别玩了。'],
    ['monitor', '你看到我打开知乎，你就提醒我别玩了。'],
    ['monitor', '你要是看见我打开视频网站，就提醒我。'],
    ['monitor', '你看见我打开视频网站，就喊我。'],
    ['monitor', '要是看到我刷视频，就叫我别玩了。'],
    ['monitor', '如果我打开视频网站，就提醒我不要玩了。'],
    ['monitor', '如果我打开视频网站，就提醒我别再刷了。'],
    ['monitor', '如果我打开视频网站，就提醒我不能再盯着屏幕了。'],
    ['monitor', '如果我打开视频网站，就让我不要玩了。'],
    ['monitor', '要是看见我打开视频网页，就叫我回去工作。'],
    ['monitor', '如果发现我在浏览购物网站，就让我回去工作。'],
    ['monitor', '请帮我监控屏幕，看到我打开视频网站就提醒我不要玩。'],
    ['monitor', '帮我盯着屏幕，提醒我不要刷视频。'],
    ['monitor', 'If I open a video site, remind me not to browse it.'],
    ['monitor', 'If I open a video site, remind me that I must not watch it.'],
    ['monitor', 'Watch the screen and remind me not to browse video sites.'],
    ['monitor', '帮我留意着屏幕，看到我刷知乎就喊我。'],
    ['monitor', '你帮我盯一下，别让我一直刷知乎。'],
    ['monitor', '你帮我看着点屏幕，有变化叫我。'],
    ['monitor', '请帮我留意一下声音，有动静就喊我。'],
    ['monitor', '别让我一直刷知乎。'],
    ['monitor', '别让我一直玩手机。'],
    ['narration', '你对我的画面进行不断的描述。'],
    ['narration', '你不断地描述我的屏幕。'],
    ['narration', '不断的描述我的画面。'],
    ['narration', '请对当前的视频画面进行持续描述。'],
    ['narration', '你对摄像头画面做持续的解说。'],
    ['narration', '请持续的解说摄像头的场景。'],
    ['narration', '请对我的屏幕进行持续的讲解。'],
    ['narration', '你一直给我描述画面的变化。'],
    ['narration', '接下来边看屏幕边给我讲讲变化。'],
    ['narration', '你一边看摄像头画面一边给我描述变化。'],
  ])('accepts an explicit conversational %s request: %s', (kind, request) => {
    expect(hasExplicitTaskIntent(request, kind)).toBe(true);
  });
  ...
  it.each([
    ...
    '你要是看见我打开视频网站，就别提醒我。',
    '你要是看见我打开视频网站，就不能提醒我。',
    '你要是看见我打开视频网站，就不需要提醒我。',
    '你要是发现我打开视频网站，就不必提醒我。',
    '你要是看见我打开视频网站，就别去提醒我。',
    '你要是看见我打开视频网站，就不准再提醒我。',
    '请监控屏幕，看到我打开视频网站就提醒我，但不必再监控了。',
    '你要是看见我打开视频网站。',
    '如果我打开视频网站，就让我自己玩。',
    '如果我让你看见我打开视频网站就提醒我，会怎样？',
    '如果我打开视频网站，就提醒我不要玩；不要监控我的屏幕。',
    '如果我打开视频网站，就提醒我别再玩，但不要监控我的屏幕。',
    '如果我打开视频网站，就提醒我别再玩，但别监控我的屏幕。',
    '请帮我监控屏幕，但不要提醒我。',
    '请帮我监控屏幕，看到我打开视频网站就提醒我不要玩；不要监控我的屏幕。',
    'If I open a video site, remind me not to browse it; do not monitor my screen.',
    'If I open a video site, you must not remind me.',
    'If I open a video site, there is no need to remind me.',
    'If I open a video site, you should not remind me.',
    'Watch the screen and remind me, but you must not monitor my screen.',
    '别让我失望。',
    '别让我再听你胡说。',
    '别让我一直刷存在感。',
    '你帮我盯一下，别让我失望。',
    ...
    '他说“接下来边看屏幕边给我讲讲变化”。',
    '不要边看屏幕边给我讲讲变化。',
  ])('does not turn reports or a refusal into monitoring: %s', (request) => {
    for (const kind of KINDS)
      expect(hasExplicitTaskIntent(request, kind), kind).toBe(false);
  });
