 ...
 *
 *   RUN_QODERCLI_SMOKE=1 npx vitest run src/manual/qodercli-acp.test.ts
 *
...
const enabled = process.env['RUN_QODERCLI_SMOKE'] === '1';
const available = enabled
  ? spawnSync(QODERCLI, ['--version'], { encoding: 'utf8' })
  : undefined;
const skip = !enabled || available?.status !== 0;
